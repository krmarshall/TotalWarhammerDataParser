...
const ovn3PackNames = ['ovn_albion', 'ovn_araby', 'ovn_fimir', 'ovn_citadel_of_dusk', 'ovn_grudgebringers', 'ovn_dread_king'];
const ovn3PackNamesEnum = {
  ovn_albion: 'Albion',
  ovn_araby: 'Araby',
  ovn_citadel_of_dusk: 'Citadel of Dusk',
  ovn_dread_king: 'Dread King Legions',
  ovn_fimir: 'Fimir',
